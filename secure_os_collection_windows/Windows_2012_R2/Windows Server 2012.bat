...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$OutputEncoding = [Console]::OutputEncoding = [System.Text.Encoding]::UTF8; $PSDefaultParameterValues['*:Encoding'] = 'utf8'; Invoke-Command -ScriptBlock ([ScriptBlock]::Create([System.IO.File]::ReadAllText('%~dp0Windows Server 2012.ps1', [System.Text.Encoding]::UTF8)))"
