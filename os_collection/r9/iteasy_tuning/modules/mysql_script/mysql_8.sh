#!/bin/bash
# mysql_8.sh (개선: 세션 버퍼 K단위 floor 적용, 0M 방지, net_buffer_length 기본값 복원, key_buffer_size cap 완화)
...
FLOOR_SORT_KIB=256; FLOOR_JOIN_KIB=256; FLOOR_READ_KIB=128; FLOOR_RND_KIB=256
