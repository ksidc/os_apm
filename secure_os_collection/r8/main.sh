...
source /usr/local/src/secure_os_collection/r8/system.sh || {
...
source /usr/local/src/secure_os_collection/r8/services.sh || {
...
echo "활성 저장소가 더 높은 Rocky 8.x 기준이면 커널과 OS 마이너 패키지도 그 기준으로 업데이트됩니다."
echo "특정 Rocky 8.x 버전을 고정해야 하면 N을 선택하세요."
